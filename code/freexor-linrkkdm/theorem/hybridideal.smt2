(define-fun randomness-mapping-GARBLE
    ...
    (or
        ...
        (and
            ...
            (= sample-id-right (sample-id "R" "GARBLE" "R_00"))
            (= sample-offset-left 0)
            (= sample-offset-right 0)
        )
        (and
            (= sample-id-left (sample-id "R1" "GARBLE" "R_01"))
            (= sample-id-right (sample-id "R" "GARBLE" "R_01"))
            (= sample-offset-left 0)
            (= sample-offset-right 0)
        )
        (and
           (= sample-id-left (sample-id "GHybrid" "GETRANDOMS" "R_10"))
           (= sample-id-right (sample-id "R" "GARBLE" "R_10"))
           (= sample-offset-left 0)
           (= sample-offset-right 0)
        )
        (and
            (= sample-id-left (sample-id "R1" "GARBLE" "R_11"))
            (= sample-id-right (sample-id "R" "GARBLE" "R_11"))
            (= sample-offset-left 0)
            (= sample-offset-right 0)
        )
        (and
        ...
        (and
            ...
            (= sample-id-right (sample-id "R" "GARBLE" "B_0"))
            (= sample-offset-left 0)
            (= sample-offset-right 0)
        )
        (and
            (= sample-id-left (sample-id "R1" "GARBLE" "C_0"))
            (= sample-id-right (sample-id "R" "GARBLE" "C_0"))
            (= sample-offset-left 0)
            (= sample-offset-right 0)
        )

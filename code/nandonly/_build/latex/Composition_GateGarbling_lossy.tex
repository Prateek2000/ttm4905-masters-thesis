...
\title{GateGarbling Game}
\begin{document}
\maketitle
\begin{center}
\input{CompositionGraph_GateGarbling.tex}
\end{center}
\begin{pchstack}
\input{Package_garbleNANDgate_in_GateGarbling_lossy.tex}
\pchspace
\input{Package_XOR_in_GateGarbling_lossy.tex}
\pchspace
\end{pchstack}
\end{document}

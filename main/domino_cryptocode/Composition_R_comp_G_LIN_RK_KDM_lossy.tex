...
\title{R_comp_G_LIN_RK_KDM Game}
\begin{document}
\maketitle
\begin{center}
\input{CompositionGraph_R_comp_G_LIN_RK_KDM.tex}
\end{center}
\begin{pchstack}
\input{Package_G_LIN_RK_KDM_in_R_comp_G_LIN_RK_KDM_lossy.tex}
\pchspace
\input{Package_R_in_R_comp_G_LIN_RK_KDM_lossy.tex}
\pchspace
\end{pchstack}
\end{document}

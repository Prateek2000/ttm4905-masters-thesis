...
\scalebox{0.66}{\input{CompositionGraph_GLINRKKDM.tex}}
\end{minipage}
\begin{minipage}{.245\textwidth}
...
\scalebox{0.66}{\input{CompositionGraph_RcompGLINRKKDM.tex}}
\end{minipage}
\begin{minipage}{.245\textwidth}
...
\begin{center}
\input{CompositionGraph_GLINRKKDM.tex}
\end{center}
\begin{pchstack}
\input{Package_GLINRKKDM_in_GLINRKKDM.tex}
\pchspace
\end{pchstack}
\clearpage
...
\begin{center}
\input{CompositionGraph_RcompGLINRKKDM.tex}
\end{center}
\begin{pchstack}
\input{Package_GLINRKKDM_in_RcompGLINRKKDM.tex}
\pchspace
\input{Package_R_in_RcompGLINRKKDM.tex}
\pchspace
\end{pchstack}
\clearpage
...
\end{center}
\begin{pchstack}
\input{Package_SimFreeXOR0_in_GSimFreeXORReal.tex}
\pchspace
\end{pchstack}
\clearpage
